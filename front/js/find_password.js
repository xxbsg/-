    ...
    methods: {
        ...
        form_1_on_submit: function(){
            ...
            if (this.error_username == false && this.error_image_code == false) {
                axios.get(this.host+'/verifications/' + this.username + '/sms/token/?text='+ this.image_code + '&image_code_id=' + this.image_code_id, {
                        responseType: 'json'
                    })
                    .then(response => {
        ...
        send_sms_code: function(){
            ...
            axios.get(this.host+'/verifications/sms_codes/?access_token='+ this.access_token, {
                    responseType: 'json'
                })
                .then(response => {
                    // 表示后端发送短信成功
        ...
        form_2_on_submit: function(){
            ...
            if (this.error_sms_code == false) {
                axios.get(this.host + '/verifications/password/token/?sms_code=' + this.sms_code + "&username=" + this.username, {
                        responseType: 'json'
                    })
                    .then(response => {
